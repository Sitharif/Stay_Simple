      ...
      <h3>filter your search</h3>
         ...
         <div class="flex">
            ...
            <div class="box">
               ...
               <select name="offer" required class="input" required>
            ...
            <div class="box">
               ...
               <select name="type" required class="input" required>
            ...
            <select name="status" required class="input" required>
