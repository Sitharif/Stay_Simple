...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         <p><i class="fa-solid fa-money-bill-1-wave"></i><span><?= $fetch_property['price']; ?></span></p>
         <p><i class="fas fa-user"></i><span><?= $fetch_user['name']; ?></span></p>
         <p><i class="fas fa-phone"></i><a href="tel:1234567890"><?= $fetch_user['number']; ?></a></p>
         <p><i class="fas fa-home"></i><span><?= $fetch_property['type']; ?></span></p>
      ...
      <div class="flex">
         <div class="box">
            <p><i>proximity to Campus :</i><span><?= $fetch_property['bhk']; ?> </span></p>
            <p><i>gender :</i><span><?= $fetch_property['status']; ?></span></p>
         </div>
         <div class="box">
            <p><i>amenities :</i><span><?= $fetch_property['furnished']; ?></span></p>
         </div>
      </div>
